...
public class ActVideoTrimmer extends LocalizationActivity {
    ...
    private TextView txtCancel, txtChoose;
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        txtCancel = findViewById(R.id.tv_cancel);
        txtChoose = findViewById(R.id.tv_choose);
            ...
            Runnable fileUriRunnable = () -> {
                ...
                runOnUiThread(() -> {
                    ...
                    imagePlayPause.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (imagePlayPause.isSelected()){
                                imagePlayPause.setSelected(false);
                            }else{
                                imagePlayPause.setSelected(true);
                            }
                            onVideoClicked();
                        }
                    });
...
//                    imagePlayPause.setSelected(playWhenReady);
//                    imagePlayPause.setVisibility(playWhenReady ? View.VISIBLE :
//                            View.VISIBLE);
                }
...
//            trimVideo();
    ...
    private String getFileName() {
        ...
        String fileDateTime = ""+calender.get(Calendar.YEAR) +
                calender.get(Calendar.MONTH) +
                calender.get(Calendar.DAY_OF_MONTH) +
                calender.get(Calendar.HOUR_OF_DAY) +
                calender.get(Calendar.MINUTE) +
                calender.get(Calendar.SECOND);
        String fName = "trimmed_video";
