...
class RedeemOfferAdapter(
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<AdapterAvailableOfferBinding>, position: Int) {
        ...
        holder.binding.clMain.setOnClickListener {
            ...
            redeemOfferListener.onOfferItemClick(list[position], position)
        }
    }

    private fun setItem(holder: BaseViewHolder<AdapterAvailableOfferBinding>, selectedPosition: Int) {
