...
import com.popiin.databinding.AdapterExploreBinding
...
class ExploreAdapter(
    ...
    private var listener: AdapterEventListener<VenueListRes.Venue>,
) : BaseRVAdapter<AdapterExploreBinding>() {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<AdapterExploreBinding>, position: Int) {
       ...
       if (exploreList[position].whatsons!!.size > 0) {
        ...
        System.out.println("@@@@@@@@@ "+openCloseText)
...
*/
        ...
        holder.binding.isFavorite = exploreList[position].isFavorite
...
/*
    fun setAllSelect(isSelected: Boolean) {
        exploreList.forEach { it.isSelected = isSelected }
    }*/
