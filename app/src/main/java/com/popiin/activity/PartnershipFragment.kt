...
import com.popiin.R
import com.popiin.databinding.FragmentPartnershipBinding
...
class PartnershipFragment : BaseFragment<FragmentPartnershipBinding>() {
    ...
    companion object {
        fun newInstance(): PartnershipFragment {
    ...
    private fun callAddPartnershipApi() {
        if (isInternetConnect()) {
            showProgress()
            val call: Call<CommonRes> = apiInterface.doAddPartnership(
